...
const deleteBtn = document.querySelector(".clear-all")
...
const saveInputHandler = () => {
 const inputElement = document.querySelector(".text-ipt")
...
onst deleteAllHandler = () => {
  chrome.storage.local.remove(["items"], () => {
    getItemList(); // refresh the list after deletion
  });
}
