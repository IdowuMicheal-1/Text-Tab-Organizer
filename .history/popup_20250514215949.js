  ...
  result.items.map((items,index) => {
    ...
    li.innerHTML = `
          ...
          <p class="content-text">
            ...
            <button data-id="${items.id}"><img src= "./assets/edit.png" class="edit-btn"><button>
          </div>
    ...
    // const idx = parseInt (e.currentTarget.getAttribute("data-id"))
...
clearBtn.addEventListener("click", () => {
  const confirmed = confirm("Are you sure you want to delete all saved items?");
  if (confirmed) {
    chrome.storage.local.clear(() => {
      console.log("Storage cleared");
      getItemList(); // Refresh UI after clearing
    });
  }
});