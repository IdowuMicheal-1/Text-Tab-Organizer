  ...
  result.items.map((items,index) => {
    ...
    li.innerHTML = `
          ...
          <p class="content-text">
            ...
            <button data-link="${items.id}"><img src= "./assets/edit.png" class="edit-btn"><button>
          </div>
          <p><a href="${items.link}" target="_blank"><img src= "./assets/edit.png" class="edit-btn"></a></p>
